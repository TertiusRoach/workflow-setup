    ...
    return (
      e &&
        eachProp(e, function (e, t) {
          (!r && hasProp(i, t)) ||
            (!n || 'object' != typeof e || !e || isArray(e) || isFunction(e) || e instanceof RegExp ? (i[t] = e) : (i[t] || (i[t] = {}), mixin(i[t], e, r, n)));
        }),
      i
    );
  }
            ...
            return (
              ...
              'string' == typeof e
                ? isFunction(t)
                  ...
                  ? req.get(l, e, o, s)
                  : ((r = S(e, o, !1, !0).id),
                    hasProp(m, r) ? m[r] : O(makeError('notloaded', 'Module name "' + r + '" has not been loaded yet for context: ' + u + (o ? '' : '. Use require([])'))))
                : (T(),
                  l.nextTick(function () {
